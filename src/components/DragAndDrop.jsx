                        ...
                        <div className="" key={box.id} onDragOver={() => draggingOver(event, box.id)} onDrop={() => onDrop(event, box.id)}>
                            <div className="">
                                ...
                                {box.name != 'Delete' ? (
                                    ...
                                    <div className="flex justify-center w-60 h-60 items-center">
                                        <div className="w-60 h-60 bg-[#272627] border border-[#404040] rounded-md flex justify-center items-center active:bg-red-500">
